...
const EN_MESSAGES_PATH = path.resolve(process.cwd(), "messages/en.json");
const CS_MESSAGES_PATH = path.resolve(process.cwd(), "messages/cs.json");
const BLOG_PAGE_PATH = path.resolve(process.cwd(), "src/app/[locale]/(marketing)/blog/page.tsx");
