    ...
    <section className={cn("py-28 lg:py-24", className)}>
      <div className="container max-w-6xl">
        <div className="grid gap-4 text-start md:grid-cols-2 xl:grid-cols-4">
          {plans.map((plan) => {
            const monthlyPrice = t(`plans.${plan.key}.monthlyPrice`);
            const yearlyPrice = t(`plans.${plan.key}.yearlyPrice`);
              ...
              >
                ...
                >
                  <div className="space-y-2">
                    <h3 className="text-foreground font-semibold">{t(`plans.${plan.key}.name`)}</h3>
