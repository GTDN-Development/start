...
} from "@/features/settings/actions/device-session-actions";
...
function resolveDeviceTitle(session: DeviceSessionListItem, t: SettingsTranslationFn): string {
