...
> {
  ...
  try {
    ...
    logServiceError("settings-device-session-actions", "signOutOtherDevicesAction", error);
...
export async function signOutDeviceAction(input: {
  ...
  try {
    ...
    logServiceError("settings-device-session-actions", "signOutDeviceAction", error);
