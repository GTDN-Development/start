...
- [application-composition.ts](/Users/fanda/Dev/start/apps/web/src/features/application/application-composition.ts) builds the shell model: app entry href and organization navigation.
