...
- The E2E runner sets `NEXT_PUBLIC_ORGANIZATIONS_ENABLED=true` so organization browser flows stay
...
- PDF tests cover the Gotenberg client, the document export route, and the sample document template.
